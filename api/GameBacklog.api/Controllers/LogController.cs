...
public class LogController : ControllerBase
{
    ...
    private int GetCurrentUserId()
    {
        var userIdClaim =
            ...
            //EXPLANATION: Checks two sections of User to find the identifier
        ...
        throw new UnauthorizedAccessException("Authenticated user is missing a valid user ID claim.");
    }
}
